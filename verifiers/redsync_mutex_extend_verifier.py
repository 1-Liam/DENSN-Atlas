"""External verifier for the real-world redsync mutex-extend bundle."""
...
EXPECTED_REPO = "https://github.com/go-redsync/redsync"
EXPECTED_COMMIT = "7a6f793e6fdad02673681d67bac13a1f04c9c7de"
...
def verify_manifest(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if (
        ...
        return {
            ...
            "artifact_ids": [],
            "verifier_name": "redsync_mutex_extend_verifier",
    ...
    markers = {
        "ExtendContext": "ExtendContext" in source_text,
        "ErrExtendFailed": "ErrExtendFailed" in source_text,
        "touch(": "touch(" in source_text,
        "TestMutexExtendExpired": "TestMutexExtendExpired" in source_text,
        "TestSetNXOnExtendFailsToAcquireLockWhenKeyIsTaken": (
            "TestSetNXOnExtendFailsToAcquireLockWhenKeyIsTaken" in source_text
        ),
        "redsync: failed to extend lock": "redsync: failed to extend lock"
    ...
    open_token = str(roles.get("acquire", "LOCK"))
    close_token = str(roles.get("release", "UNLOCK"))
    action_token = str(roles.get("extend", "EXTEND"))
