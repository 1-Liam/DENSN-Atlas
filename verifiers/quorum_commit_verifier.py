"""External verifier for the artifact-backed quorum-commit benchmark."""
...
def verify_manifest(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if parent_roles["commit"] < 1 or parent_roles["pending"] < 1:
        return {
            ...
            "artifact_ids": [],
            "verifier_name": "quorum_commit_verifier",
            "details": {"manifest_path": str(manifest_path)},
        }
    if blanket_roles["ack"] < required_ack_count or blanket_roles["clear"] < 1:
        return {
            "status": "fail",
            "passed": False,
            "failed": True,
    ...
    if required_stable and blanket_roles["stable"] < 1:
        return {
            "status": "fail",
            "passed": False,
            "failed": True,
            "counterexample": {
                "reason": "missing_stable_blanket_role",
                "blanket_roles": dict(blanket_roles),
            },
            "artifact_ids": [],
            "verifier_name": "quorum_commit_verifier",
    ...
    return {
        ...
        "details": {
            ...
            "source_contains_explicit_commit_ready": "commit_ready" in source_text,
        },
    }
